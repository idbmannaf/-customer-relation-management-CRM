                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                ...
                                @if ($employee->team_admin || $employee->addedBy_id == auth()->user()->id)
                                    <a class="dropdown-item"
                                        href="{{ route('employee.myCustomers.edit', $customer) }}">Edit</a>
                                ...
                                <a class="dropdown-item"
                                    href="{{ route('employee.customerOffer', $customer) }}">Offers</a>
                                <a class="dropdown-item"
                                    href="{{ route('employee.customerTransactionHistory', $customer) }}">Transaction History</a>
