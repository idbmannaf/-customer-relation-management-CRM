...
@section('content')
    <div class="card shadow">
        <div class="card-header bg-info">
            <div class="card-title">Edit Customer Office : {{$office->title}}
                {{-- <a href="{{route('employee.customerCompanyOffice',$customer_company)}}" class="btn btn-danger">back</a> --}}
        ...
        <div class="card-body">
            ...
            <form action="{{ route('employee.myCustomerOfficeUpdate',['customer'=>$customer ,'office'=>$office]) }}" method="POST" enctype="multipart/form-data">
                @method('PATCH')
                @csrf
                <div class="row">
