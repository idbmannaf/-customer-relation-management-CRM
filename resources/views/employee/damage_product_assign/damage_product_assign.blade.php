                            ...
                            <td>
                                @if (!$item->status)
                                    <div class="btn-group btn-sm">
                                        <a href="{{ route('employee.sendReceiveUnusedProductToTeamMember', ['unused' => $item, 'status' => 'repair']) }}"
                                            class="btn btn-success btn-xs">Repair</a>
                                        <a href="{{ route('employee.sendReceiveUnusedProductToTeamMember', ['unused' => $item, 'status' => 'recharge']) }}"
                                            class="btn btn-warning btn-xs">Recharge</a>
                                        <a href="{{ route('employee.sendReceiveUnusedProductToTeamMember', ['unused' => $item, 'status' => 'bad']) }}"
