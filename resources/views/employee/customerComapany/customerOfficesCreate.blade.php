...
@section('content')
    <div class="card shadow">
        <div class="card-header bg-info">
            <div class="card-title">Customer Compnay Office Location Create
            </div>
        </div>
        <div class="card-body">
            @include('alerts.alerts')
            <form action="{{ route('employee.customerCompanyOfficeAdd',['customer_company'=>$customer_company]) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="company" value="{{$customer_company->name}}">
                <div class="row">
