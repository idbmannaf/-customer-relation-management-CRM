    ...
    <div class="card-body service_log">
                        ...
                        <div class="d-flex justify-content-start flex-wrap" style="flex: 0 1;">
                            ...
                            <div class="flex-auto pl-3">
                                <input type="text" name="mobile_number" id="mobile_number" class="form-control"
                                    value="{{ old('mobile_number') ?? $visit_plan->customer->mobile }}">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="d-flex justify-content-between flex-wrap">
                ...
                <label for="new_installation" class="d-flex align-items-center font-weight-normal">
                    <input type="checkbox" class="custom_checkbox" id="new_installation" value="new_installation"
                        ...
                        {{ is_array(old('call_description')) && in_array('new_installation', old('call_description')) ? 'checked' : '' }}>&nbsp;
                ...
                <label for="replacement" class="d-flex align-items-center font-weight-normal"> <input type="checkbox"
                        ...
                        name="call_description[]"
                        {{ is_array(old('call_description')) && in_array('replacement', old('call_description')) ? 'checked' : '' }}>&nbsp;
                    Replacement</label>
                ...
                <label for="battery_replace" class="d-flex align-items-center font-weight-normal">
                    <input type="checkbox" class="custom_checkbox" value="battery_replace" id="battery_replace"
                        name="call_description[]"
                        {{ is_array(old('call_description')) && in_array('battery_replace', old('call_description')) ? 'checked' : '' }}>&nbsp;
                    Battery Replace</label>

                <label for="service_maintaince" class="d-flex align-items-center font-weight-normal">
                    <input type="checkbox" class="custom_checkbox" value="service_maintaince"
                        id="service_maintaince" name="call_description[]"
                        {{ is_array(old('call_description')) && in_array('service_maintaince', old('call_description')) ? 'checked' : '' }}>&nbsp;
                ...
                <div class="row py-3">
                    <div class="col-12 col-md-4">
                        ...
                        <select name="category" id="category"
                            data-url="{{ route('employee.categoryToServiceProduct', ['visit_plan' => $visit_plan->id]) }}"
                            class="form-control">
                    ...
                    <table class="table table-bordered table-sm text-nowrap">
                        ...
                        <tbody class="sericeProductShow">
                            @foreach ($service_products as $product)
                                @include('employee.visitPlan.visit.part.sericeProductShow')
                            @endforeach
                        </tbody>
                    </table>
                </div>
                            ...
                            <tr>
                                <td>
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" class="custom-control-input" id="customSwitch1"
                                            ...
                                            {{ old('ventilation_system') ? 'checked' : '' }}>
                                ...
                                <td>
                                    <input type="text" name="room_temperature"
                                        value="{{ old('room_temperature') }}" id="room_temperature">
                                </td>
                                <td>
                ...
                <div class="table-responsive ">
                    <table class="table table-bordered table-sm text-nowrap">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="earthen_voltage"
                                        value="{{ old('earthen_voltage') }}" id="earthen_voltage">
                                </td>
                                <td>
                            ...
                            <tr>
                                <td><input type="text" value="{{ old('battery_brand') }}" name="battery_brand">
                                </td>
                                ...
                                <td><input type="text" value="{{ old('battery_time') }}" name="battery_time">
                                </td>
                                            ...
                                            <td>
                                                <div class="custom-control custom-switch">
                                                    <input type="checkbox" class="custom-control-input"
                                                        ...
                                                        {{ old('motherboard_checked') ? 'checked' : '' }}>
                                            ...
                                            <td>
                                                <div class="custom-control custom-switch">
                                                    <input type="checkbox" class="custom-control-input"
                                                        ...
                                                        {{ old('motherboard_cleaned') ? 'checked' : '' }}>
                                                    <label class="custom-control-label"
                                            ...
                                            <td>
                                                <div class="custom-control custom-switch">
                                                    <input type="checkbox" class="custom-control-input"
                                                        ...
                                                        {{ old('ac_dc_able_checked') ? 'checked' : '' }}>
                                                    <label class="custom-control-label"
                                            ...
                                            <td>
                                                <div class="custom-control custom-switch">
                                                    <input type="checkbox" class="custom-control-input"
                                                        ...
                                                        {{ old('ac_dc_able_cleaned') ? 'checked' : '' }}>
                                                    <label class="custom-control-label"
                                            ...
                                            <td>
                                                <div class="custom-control custom-switch">
                                                    <input type="checkbox" class="custom-control-input"
                                                        ...
                                                        {{ old('battert_ernubak_checked') ? 'checked' : '' }}>
                                                    <label class="custom-control-label"
                                            ...
                                            <td>
                                                <div class="custom-control custom-switch">
                                                    <input type="checkbox" class="custom-control-input"
                                                        ...
                                                        {{ old('battert_ernubak_cleaned') ? 'checked' : '' }}>
                                                    <label class="custom-control-label"
        ...
        <div class="">
            <div class="requirment">
                <div class=" @if (Agent::isMobile()) bg-success p-2 @else bg-head @endif ">Requirements of
                    Batteries/Spare parts to solve the problems</div>
                <div class="table-responsive">
                    <table class="table table-borderd table-sm text-nowrap">
                        ...
                        <tbody class="showServiceRequirements">
                            ...
                            <tr>
                                {{-- <td></td> --}}
                                <td><input type="text" name="problem" class="problem form-control"
                                        placeholder="Problem"> <br>
                                ...
                                <td><input type="text" name="unit" class="unit form-control"
                                        placeholder="Unit"> <br>
                                ...
                                <td><a href="{{ route('employee.addRequirementsOfBattAndSpearPartAjax', ['visit_plan' => $visit_plan]) }}"
                                        class="btn btn-sm btn-success addRequre @if (Agent::isMobile()) form-control @endif"><i
        ...
        @if (Agent::isDesktop())
            ...
            <div class="tagline">
                Corporate Office: Concord Tower, Suit No. 1401, 113 Kazi Nazrul lslam Ave, Dhaka" Registered Office:
                Motaleb
