...
@section('content')
    <div class="card shadow">
        ...
        <div class="card-body p-1">
            <form action="{{ route('employee.customerVisitStore', $visit_plan) }}" method="POST">
                @csrf
                ...
                <div class="card">
                    ...
                    @if ($visit_plan->service_type == 'service')
                        @include('employee.visitPlan.visit.part.service')
                    @endif
                    @if ($visit_plan->service_type == 'sales')
                        {{-- @include('employee.visitPlan.visit.part.sales') --}}
                    @endif
                    @if ($visit_plan->service_type == 'collection')
                        @include('employee.visitPlan.visit.part.collection')
                    @endif
...
@push('js')
    ...
    @include('employee.visitPlan.visit.part.serviceScript')
@endpush
