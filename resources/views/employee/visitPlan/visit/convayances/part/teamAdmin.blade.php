<div class="card">
    ...
    <div class="card-body" id="printArea">
        ...
        @if ($convayances->status != 'approved')
                ...
                <table class="table table-bordered table-sm text-nowarp">
                    ...
                    <tbody>
                        <tr class="@if (Agent::isMobile()) ifMobile @endif">
                            <td><input type="time" name="start_time" class="form-control start_time" id="start_time">
                            </td>
                            <td><input type="time" name="end_time" class="form-control end_time" id="end_time">
                            </td>
                            <td><input type="text" name="start_from" class="form-control start_from" id="start_from">
                            </td>
                            <td><input type="text" name="start_to" class="form-control start_to" id="start_to">
                            </td>
                            <td>
            ...
            <div class="submit">
                <form
                    ...
                    @elseif ($convayances->status == 'pending')
