...
@push('title')
    | Employee Dashboard |  Office Visit Dates
@endpush
            ...
            <div class="table-responsive">
                <table class="table table-borderd table-sm text-nowrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <a href="{{route('employee.myEmployeeOfficeVisitByDate',['employee'=>$employee,'date'=>$office_visit_date->date])}}">{{$office_visit_date->date}}</a>
                            </td>
