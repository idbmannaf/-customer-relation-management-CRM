...
@section('content')
    <div class="card shadow">
        ...
        <div class="card-body">
                    ...
                    <div class="col-12 col-md-10 m-auto">
                        <div class="row">
                            ...
                            <div class="col-12 col-md-1">
                                ...
                                <a href="{{ route('employee.addProductToSendRequestToTheCustomerAjax', $call) }}"
                    ...
                    <tbody class="showItem">
                        @foreach ($call->call_products as $item)
                            <tr>
                                ...
                                <input type="hidden" class="method" value="{{ route('employee.deleteProductToSendRequestToTheCustomerAjax', ['call' => $call, 'item' => $item]) }}">
                                </td>
            ...
            @if (!$call->sent_product())
                <form action="{{ route('employee.sendRequestToTheCustomerPost', $call) }}" method="POST">
                    @csrf
                    <div class="row">
