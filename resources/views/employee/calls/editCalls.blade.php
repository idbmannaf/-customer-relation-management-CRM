...
@section('content')
    <div class="card shadow">
        ...
        <div class="card-body">
            <form action="{{ route('employee.updateCalls', $call) }}" method="POST">
                @csrf
                <div class="row">
                    ...
                    @if ($call->approved_at)
                        <div class="form-group col-12 col-md-6" id="userField">
                            ...
                            <input type="hidden" name="customer" value="{{ $call->customer->id }}">
                            <select id="customer" name="customer_" disabled
                                data-url="{{ route('employee.getCustomerOffice') }}"
                                class="form-control  @error('customer') is-invalid @enderror ">
                                <option selected value="{{ $call->customer->id }}">
                    ...
                    @else
                        <div class="form-group col-12 col-md-6" id="userField">
                            ...
                            {{-- <label for="customer">Customer:</label>
                            <select id="customer" name="customer" data-url="{{ route('employee.getCustomerOffice') }}"
                    ...
                    <div class="col-12">
                        @if ($employee->team_admin)
                            <div class="col-12 col-md-6 text-start pt-2">
                                <label for=""></label>
                                <label for="approved_at" class="form-label"><input
                                        {{ $call->approved_at ? 'checked' : '' }} type="checkbox" name="approved_at"
                                        id="approved_at"> Approved? </label>
                            </div>
