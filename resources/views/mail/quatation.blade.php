...
<body
    ...
    <div style="background-color:#fff;margin:30px;box-sizing:border-box;font-size:16px;">
        ...
        <h2 style="padding:20px 40px;margin:0;color:#394453;box-sizing:border-box;"> <a
                href="{{ route('employee.customerOfferDetails', $offer) }}" target="_blank"> View In Web</a></h2>
        <div style="box-sizing:border-box;padding:0 40px 20px;">
            <b>Ref:</b> {{ $offer->ref }} <br>
            <b>Date:</b> {{ $offer->date }}<br>
            <b style="padding-top: 5px;">To:</b> {!! $offer->to !!} <br>
                ...
                <table class="table table-sm table-bordered" style="width: 100%;border-collapse: collapse;">
                    <thead style="background-color: gray">
                        <tr style="border: 1px solid black;">
                            ...
                            <th style="border: 1px solid black;">Total Price (BDT)</th>
                        </tr>
                    </thead>
                    <tbody class="showItem">
                        @foreach ($offer->items as $item)
                            <tr style="border: 1px solid black;">
                                ...
                                <td style="border: 1px solid black;">{{ $item->unit_price }}
                                </td>
                                <td style="border: 1px solid black;">{{ $item->total_price }}</td>
                            </tr>
                        @endforeach
                    </tbody>
                    <tfoot>
