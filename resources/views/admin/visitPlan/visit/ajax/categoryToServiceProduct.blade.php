<div class="row">
    <div class="col-12 col-md-10">
        ...
        <select id="service_product" name="product" class="form-control user-select service_product"
            ...
            @if ($category_id == 0) data-ajax-url="{{ route('global.productAllAjax') }}"
            @else
            data-ajax-url="{{ route('global.productAllAjax', ['category' => $category_id]) }}" @endif
    ...
    <div class="col-12 col-md-2 pt-4 d-flex justify-content-start align-items-center">
        @if ($visit)
            <a href="{{ route('admin.ServiceProductAjax', $visit_plan) }}"
