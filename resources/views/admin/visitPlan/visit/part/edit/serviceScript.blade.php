...
<script>
    ...
    //     e.preventDefault();
    //     var that = $(this);
    //     var description = that.closest('tr').find('.description').val();
    //     var quantity = that.closest('tr').find('.quantity').val();
    //     var unit = that.closest('tr').find('.unit').val();
    //     var visit_id = that.attr('data_visit_id');
    //     // Validation Start
    //     if (description == null || description == '') {
    //         that.closest('tr').find('.desError').text("Description Required");
    //         return;
    //     } else {
    ...
    //                 that.closest('tr').find('.description').val('');
    ...
    //     var product_id = that.closest('tr').find('#product_id').val();
    //     var quantity = that.closest('tr').find('.quantity').val();
    //     var unit = that.closest('tr').find('.unit').val();
    //     // Validation Start
    ...
    //                 that.closest('tr').find('#product_id').val('');
    //                 that.closest('tr').find('.quantity').val('');
    //                 that.closest('tr').find('.unit').val('');
    //                 that.closest('tr').find('#description').val('').change();
    //                 serialMaintain();
    //                 $('.service_product').select2({
    //                     theme: 'bootstrap4',
    //                     closeOnSelect: true,
