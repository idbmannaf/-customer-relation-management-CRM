<tr>
    ...
    <input type="hidden" class="productDescriptionupdate" value="{{route('admin.serviceProductUpdateAjax',['visit_plan'=>$visit_plan,'item'=>$product])}}">
    </td>
    ...
    <td>
        <a href="{{route('admin.serviceProductDeleteAjax',['visit_plan'=>$visit_plan,'item'=>$product])}}" class="text-danger serviceProductDeleteBtn" ><i class="fas fa-trash"></i></a>
    </td>
