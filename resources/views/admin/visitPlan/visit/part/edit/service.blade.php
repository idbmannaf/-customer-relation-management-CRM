    ...
    <div class="card-body service_log">
                ...
                <div class="col-12 col-md-5">
                    <div class="d-flex justify-content-start flex-wrap" style="flex: 0 1;">
                        ...
                        <div class="flex-auto pl-3">
                            <input type="text" name="mobile_number" class="form-control" value="{{ $visit->mobile_number }}">
        ...
        <div class="d-flex justify-content-between flex-wrap">
            ...
            <label for="replacement" class="d-flex align-items-center font-weight-normal"> <input type="checkbox"
                    ...
                    {{ has_in_array($visit->call_description, 'replacement') ? 'checked' : '' }} value="replacement"
                    value="replacement" name="call_description[]">&nbsp; Replacement</label>
        ...
        <div class="product_description">
            ...
            <div class="row py-3">
                <div class="col-12 col-md-4">
                    ...
                    <select name="category" id="category"
                        data-url="{{ route('admin.categoryToServiceProduct', ['visit_plan' => $visit_plan->id, 'visit' => $visit->id]) }}"
            ...
            {{-- <div class="row  pb-2 showProduct">
                ...
                <table class="table table-bordered table-sm text-nowrap">
                    ...
                    <tbody class="sericeProductShow">
                        @foreach ($visit->serviceProducts as $product)
                            @include('admin.visitPlan.visit.part.edit.sericeProductShow')
                        @endforeach
                    </tbody>
                </table>
            </div>
                            ...
                            <th colspan="8">
                                <table class="table">
                                    <tr>
                                        ...
                                        <td>
                                            <div class="custom-control custom-switch">
                                                <input type="checkbox" class="custom-control-input" id="motherboard_checked"
                                                    name="motherboard_checked"
                                                    {{ $visit->service_maintainces && $visit->service_maintainces->motherboard_checked ? 'checked' : '' }}>
                                                <label class="custom-control-label" for="motherboard_checked">Checked</label>
                                            </div>

                                        </td>
                                        <td>
                                            <div class="custom-control custom-switch">
                                                <input type="checkbox" class="custom-control-input" id="motherboard_cleaned"
                                                    name="motherboard_cleaned"
                                                    {{  $visit->service_maintainces &&$visit->service_maintainces->motherboard_cleaned ? 'checked' : '' }}>
                                                <label class="custom-control-label" for="motherboard_cleaned">Cleaned</label>
                                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="custom-control custom-switch">
                                                <input type="checkbox" class="custom-control-input" id="ac_dc_able_checked"
                                                    name="ac_dc_able_checked"
                                                    {{ $visit->service_maintainces && $visit->service_maintainces->ac_dc_cable_checked ? 'checked' : '' }}>
                                                <label class="custom-control-label" for="ac_dc_able_checked">Checked</label>
                                            </div>

                                        </td>
                                        <td>
                                            <div class="custom-control custom-switch">
                                                <input type="checkbox" class="custom-control-input" id="ac_dc_able_cleaned"
                                                    name="ac_dc_able_cleaned"
                                                    {{ $visit->service_maintainces &&$visit->service_maintainces->ac_dc_cable_cleaned ? 'checked' : '' }}>
                                                <label class="custom-control-label" for="ac_dc_able_cleaned">Cleaned</label>
                                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="custom-control custom-switch">
                                                <input type="checkbox" class="custom-control-input" id="breaker_checked"
                                                    name="breaker_checked"
                                                    {{ $visit->service_maintainces && $visit->service_maintainces->breaker_checked ? 'checked' : '' }}>
                                                <label class="custom-control-label" for="breaker_checked">Checked</label>
                                            </div>

                                        </td>
                                        <td>
                                            <div class="custom-control custom-switch">
                                                <input type="checkbox" class="custom-control-input" id="breaker_cleaned"
                                                    name="breaker_cleaned"
                                                    {{ $visit->service_maintainces && $visit->service_maintainces->breaker_cleaned ? 'checked' : '' }}>
                                                <label class="custom-control-label" for="breaker_cleaned">Cleaned</label>
                                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="custom-control custom-switch">
                                                <input type="checkbox" class="custom-control-input" id="socket_checked"
                                                    name="socket_checked"
                                                    {{ $visit->service_maintainces && $visit->service_maintainces->socket_checked ? 'checked' : '' }}>
                                                <label class="custom-control-label" for="socket_checked">Checked</label>
                                            </div>

                                        </td>
                                        <td>
                                            <div class="custom-control custom-switch">
                                                <input type="checkbox" class="custom-control-input" id="socket_cleaned"
                                                    name="socket_cleaned"
                                                    {{ $visit->service_maintainces && $visit->service_maintainces->socket_cleaned ? 'checked' : '' }}>
                                                <label class="custom-control-label" for="socket_cleaned">Cleaned</label>
                                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="custom-control custom-switch">
                                                <input type="checkbox" class="custom-control-input" id="battery_ernubak_checked"
                                                    name="battert_ernubak_checked"
                                                    {{ $visit->service_maintainces && $visit->service_maintainces->battery_ernubak_checked ? 'checked' : '' }}>
                                                <label class="custom-control-label" for="battery_ernubak_checked">Checked</label>
                                            </div>

                                        </td>
                                        <td>
                                            <div class="custom-control custom-switch">
                                                <input type="checkbox" class="custom-control-input" id="battery_ernubak_cleaned"
                                                    name="battert_ernubak_cleaned"
                                                    {{ $visit->service_maintainces &&$visit->service_maintainces->battery_ernubak_cleaned ? 'checked' : '' }}>
                                                <label class="custom-control-label" for="battery_ernubak_cleaned">Cleaned</label>
                                            </div>
            ...
            <div class="table-responsive">
                <table class="table table-borderd table-sm text-nowrap">
                    ...
                    <tbody class="showServiceRequirements">
                        ...
                        <input type="hidden" id="total_service_products" value="{{count(
                        ...
                        <tr>
                            ...
                            <td><select name="spear_part_cat" id="spear_part_cat" class="spear_part_cat form-control">
        ...
        <div class="call_status">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-3">
                    <label for="call_status2"> <input type="radio" {{ $visit->call_status == 'pending' ? 'checked' : '' }} name="call_status" id="call_status2"
                            value="pending"> Pending</label>
                </div>
                <div class="col-12 col-md-3">
                    <label for="call_status3"> <input type="radio" {{ $visit->call_status == 'reviewed' ? 'checked' : '' }} name="call_status" id="call_status3"
                ...
                {{-- <div class="col-12 col-md-3"> <label for="call_status1"> <input type="radio"
                            {{ $visit->call_status == 'completed' ? 'checked' : '' }} name="call_status"
                            id="call_status1" value="completed"> Completed</label></div>
                <div class="col-12 col-md-3">
                ...
                <div class="col-12 col-md-6">
                    <label for="call_status3"> <input type="radio"
                            {{ $visit->call_status != 'pending' && $visit->call_status != 'completed' ? 'checked' : '' }}
                            name="call_status" id="call_status3" value="other">Other</label>
                    <input type="text" name="others_call_status" value="{{ $visit->others_call_status }}"
                        id="others_call_status">
                </div> --}}
            </div>
        </div>
