...
@push('title')
    | Admin Dashboard | Office Location Edit
@endpush
...
@section('content')
    <div class="card shadow">
        <div class="card-header bg-info">
            <div class="card-title">Office Locations Edit
        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin.company.office.update',['office'=>$office,'company'=>$company]) }}" method="POST" enctype="multipart/form-data">
                @method('PATCH')
                @csrf
                <div class="row">
