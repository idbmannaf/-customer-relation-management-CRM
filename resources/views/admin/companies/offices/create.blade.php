...
@section('content')
    <div class="card shadow">
        <div class="card-header bg-info">
            <div class="card-title">Office Locations Create of {{$company->name}}
                <a href="{{route('admin.company.office',$company)}}" class="btn btn-danger btn-sm">back</a>
            </div>
        </div>
        <div class="card-body">
            @include('alerts.alerts')
            <form action="{{ route('admin.company.office.store',$company) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
