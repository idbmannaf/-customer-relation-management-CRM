        ...
        <div class="card-header bg-info">
            <div class="d-flex justify-content-between">
                <div>Edit Offer for Customers: {{ $customer->customer_name }} ({{ $customer->customer_code }})
                    <a href="{{ route('admin.customerOffer', $customer) }}" class="btn btn-warning"> Back</a>
                </div>

            </div>
        </div>
        @include('alerts.alerts')
        <form action="{{ route('admin.customerOfferUpdate', $offer) }}" method="POST">
            @csrf
            <div class="card-body">
                <div class="row">
...
@endif
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-2 pt-2 d-flex justify-content-start align-items-center">
                        <a href=""
                            data-url={{ route('admin.customerOfferItemAjax', ['customer' => $customer, 'offer' => $offer->id]) }}
                        ...
                        <tbody class="showItem">
                            @if (count($customer_offer_items))
                                @foreach ($customer_offer_items as $customer_offer_item)
                                    @include('admin.customer.offers.ajax.customerOfferItem')
                                @endforeach
                            @endif
                        </tbody>
                        <tfoot>
