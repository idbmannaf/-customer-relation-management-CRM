    ...
    <div class="row">
        <div class="col-12 col-md-6 m-auto">
            <div class="card shadow">
                ...
                <div class="card-body">
                    <form action="{{route('admin.customer_company.update',['customer_company'=>$customerCompany])}}" method="POST">
                        @method('PATCH')
                        @csrf
                        <div class="form-group">
                            ...
                            <input type="text" name="name" id="name"
                                ...
                                placeholder="Company Name here..." value="{{$customerCompany->name}}">
                            @error('name')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="address" id="address"
                                ...
                                placeholder="Address here..." value="{{$customerCompany->address}}">
                            @error('address')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            <label for="active"> <input type="checkbox" {{$customerCompany->active ? 'checked' : ''}} name="active" id="active">
                                Active</label>
                        </div>
                        <div class="form-group">
