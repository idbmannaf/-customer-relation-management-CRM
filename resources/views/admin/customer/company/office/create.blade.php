...
@push('title')
    | Admin Dashboard |Cusomer Compnay Office Location Create
@endpush
...
@section('content')
    <div class="card shadow">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin.customerCompanyOffice.store',['customer_company'=>$customer_company]) }}" method="POST" enctype="multipart/form-data">
                @csrf
