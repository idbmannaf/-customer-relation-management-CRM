                        ...
                        @foreach ($products as $item)
                            <tr>
                                ...
                                <td>
                                    ...
                                    @if (!$item->received)
                                        <a href="{{ route('admin.receivedCustomerRequestProductitem', ['item'=>$item,'status'=>'received']) }}"
                                            class="btn btn-sm btn-danger">Received</a>
                                            @elseif ($item->call->done_by && !$item->delivered)
                                        <a href="{{ route('admin.receivedCustomerRequestProductitem',['item'=>$item,'status'=>'delivered']) }}"
                                ...
                                <td>
                                    ...
                                    @elseif ($item->sent)
                                        ...
                                        @else
                                        <span class="badge badge-danger">Customer Sent</span>
                                    @endif
                                </td>
