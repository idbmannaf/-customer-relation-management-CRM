    ...
    <table class="table table-bordered table-sm text-nowrap">
        ...
        <tbody>
            @foreach ($employees as $employee)
                <tr @if(count($employees)  < 2) style="height: 100px;" @endif>
                    <td>
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                @can('employee-edit')
                                    <a class="dropdown-item" href="{{ route('admin.employee.edit', $employee) }}">Edit</a>
                                @endcan
                                ...
                                <a class="dropdown-item"
                                    href="{{ route('admin.convayancesBillHistory', $employee) }}">Convayances Bill
                                    History</a>
                                {{-- @endcan --}}
                    ...
                    <td>{{ $employee->user->officeLocation ? $employee->user->officeLocation->title : '' }}</td>
