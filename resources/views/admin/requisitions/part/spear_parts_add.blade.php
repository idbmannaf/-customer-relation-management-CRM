    ...
    <div class="card-body">
                    ...
                    <div class="col-12">
                        <div class="row">
                            ...
                            <div class="col-4"><input type="text" name="sales_order_no" id="sales_order_no"
                                    class="form-control"
                                    value="{{ old('sales_order_no') ?? $requisition->sales_order_no }}"></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-md-8">
                <div class="d-flex justify-content-start flex-wrap" style="flex: 0 1;">
                    ...
                    <div class="flex-auto"><input type="text" name="party_name" class="custom form-control"
                            value="{{ old('party_name') ?? $requisition->party_name }}"></div>
                </div>
            </div>
            <div class="col-12 col-md-4">
                <div class="d-flex justify-content-start flex-wrap" style="flex: 0 1;">
                    ...
                    <div class="flex-auto"><input type="date" name="date" required
                            class="custom form-control text-center" value="{{ old('date') ?? $requisition->date }}">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="d-flex justify-content-start flex-wrap" style="flex: 0 1;">
                    ...
                    <div class="flex-auto">
                        ...
                        <input type="text" name="sales_person" class="custom form-control text-center disable-design"
                            disabled
                            value="{{ $requisition->customer ? ($requisition->customer->employee ? $requisition->customer->employee->name : '') : '' }}">
                    </div>
                </div>
            </div>
        </div>
        {{-- {{dd($requisition->visit->visit_plan->customer_address)}} --}}
        <div class="row">
            <div class="col-12">
                <div class="d-flex justify-content-start flex-wrap" style="flex: 0 1;">
                    ...
                    <div class="flex-auto"><input type="text" name="delivery_address"
                            class="custom form-control text-center" value="{{ $requisition->delivery_address }}">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="table-responsive">
            <table class="table table-bordered">
                ...
                <tbody>
                    @foreach ($visit->offer_quotation->items()->where('product_type', 'spare_parts')->get() as $offerItem)
    ...
    <div class="card-body" id="printArea">
        ...
        <div class="table-responsive">
            <table class="table table-bordered">
                ...
                <tbody>
                    @foreach ($requisition->requisitionProducts()->where('product_type', 'spare_parts')->get() as $product)
                        <tr>
                            <td>{{ $loop->index + 1 }}</td>
                            <td>{{ $product->product_name }}</td>
                            <td>{{ $product->quantity }}
                                <input type="hidden" value="{{ $product->quantity }}" class="qty"
                                    name="qty[{{ $product->customer_offer_item_id }}]">
                            </td>
