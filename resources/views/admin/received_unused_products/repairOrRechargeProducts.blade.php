                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        @if ($item->status == 'recharge')
                                            <form
                                                action="{{ route('admin.receiveUnusedProductStatusUpdate', ['item' => $item, 'status' => 'recharge_status', 'update' => 'reuse']) }}"
                                                method="POST">
                                            @elseif ($item->status == 'repair')
                                                <form
                                                    action="{{ route('admin.receiveUnusedProductStatusUpdate', ['item' => $item, 'status' => 'repair_status', 'update' => 'reuse']) }}"
                                                    method="POST">
                                        @endif
                                        @csrf
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        @if ($item->status == 'recharge')
                                            <form
                                                action="{{ route('admin.receiveUnusedProductStatusUpdate', ['item' => $item, 'status' => 'recharge_status', 'update' => 'bad']) }}"
                                                method="POST">
                                            @elseif ($item->status == 'repair')
                                                <form
                                                    action="{{ route('admin.receiveUnusedProductStatusUpdate', ['item' => $item, 'status' => 'repair_status', 'update' => 'bad']) }}"
                                                    method="POST">
                                        @endif
                                        @csrf
