...
@section('content')
    <div class="card shadow">
        <div class="card-header bg-info">
            <div class="card-title">Company Office Locations Create
            </div>
        </div>
        <div class="card-body">
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="time" name="office_start_time"
                                class="form-control  @error('office_start_time') is-invalid @enderror  " id="lng"
                                placeholder="Start Time  Here">
                        </div>
                        <div class="form-group">
                            <label for="office_end_time">Office End Time</label>
                            <input type="time" name="office_end_time"
                                class="form-control  @error('office_end_time') is-invalid @enderror  " id="lng"
