<div class="card">
    ...
    <div class="card-body" id="printArea">
                ...
                <table class="table table-bordered table-sm text-nowarp">
                    ...
                    <tbody>
                        <tr  class="@if(Agent::isMobile()) ifMobile @endif">
                            ...
                            <td><input type="text" name="start_to" placeholder="Start To" class="form-control start_to" id="start_to">
                            </td>
                            <td>
                            ...
                            <td><button type="button"
                                    data-url="{{ route('admin.convayance.add', ['convayance' => $convayance, 'visit' => $visit]) }}"
                            ...
                            <tr  class="@if(Agent::isMobile()) ifMobile @endif">
                                <td><input type="time" name="start_time" oninput="update(this,'start_time')"
                                    ...
                                    <input type="hidden" class="update_url"
                                        value="{{ route('admin.convayance.change', ['convayance' => $convayance->id, 'item' => $item->id]) }}">
                                </td>
                                ...
                                <td>
                                    <button type="button" data-id="{{ $item->id }}"
                                        data-url="{{ route('admin.convayance.delete', ['convayance' => $convayance->id, 'item' => $item->id]) }}"
        ...
        <div class="submit">
            <form
                action="{{ route('admin.convayancesSubmit', ['convayances' => $convayance, 'visit' => $visit]) }}">
