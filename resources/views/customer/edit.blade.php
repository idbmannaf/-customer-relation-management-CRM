...
@section('content')
    <div class="card">
        <div class="card-header card-title">Update Profile</div>
        <div class="card-body">
            ...
            <form method="post" action="{{ route('customer.update', $customer) }}">
                ...
                <div class="row">
                    ...
                    <label for="email">Employee ID or Name:</label>
                    <select id="user" name="employee"
                        ...
                        <option value="{{ $customer->employee_id }}">
                            {{ $customer->employee? $customer->employee->name . '(' . $customer->employee->employee_id . ')': $customer->employee_name }}
                        </option>
                    ...
                    <div class="form-group col-12 col-md-6">
                        ...
                        <input type="text" class="form-control" readonly disabled value="@if ($customer->company_id) {{ $customer->company->name }}
                    @else
    ...
    <div class="card">
        ...
        <!-- /.card-header -->
        <div class="card-body">
            <form method="POST" action="{{ route('customer.update', ['customer' => $customer, 'type' => 'password']) }}"
                enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="type" value="password">
                <div class="form-group">
                    <label for="old_password">Old Password </label>
                    <input class="form-control @error('old_password') is-invalid @enderror " placeholder="Old Password"
                        id="old_password" name="old_password" type="password" value="">
                    @error('old_password')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" placeholder="Confirmation Password" id="password_confirmation"
